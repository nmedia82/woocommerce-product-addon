...
class NM_Textarea_wooproduct extends NM_Inputs_wooproduct{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Textarea Input', 'nm-personalizedproduct' );
		$this -> desc		= __ ( 'regular textarea input', 'nm-personalizedproduct' );
	...
	private function get_settings(){
		...
		'default_value' => array (
								...
								'desc' => __ ( 'Pre-defined value for textarea input', 'nm-personalizedproduct' )
		),
		'required' => array (
				'type' => 'checkbox',
