...
class NM_Instagram_wooproduct extends NM_Inputs_wooproduct{
	...
	private function get_settings(){
		...
		return array (
				...
				'button_label_import' => array (
						'type' => 'text',
						'title' => __ ( 'Button label', 'nm-personalizedproduct' ),
						'desc' => __ ( 'Type button label e.g: Import Photos', 'nm-personalizedproduct' ) 
				),
				'button_class' => array (
						'type' => 'text',
						'title' => __ ( 'Button class', 'nm-personalizedproduct' ),
						'desc' => __ ( 'Type class for import button', 'nm-personalizedproduct' )
				),
	
				'client_id' => array (
						'type' => 'text',
						'title' => __ ( 'Client ID', 'nm-personalizedproduct' ),
						'desc' => __ ( 'Get client id from your Instagram app.', 'nm-personalizedproduct' )
				),
				'client_secret' => array (
						'type' => 'text',
						'title' => __ ( 'Client secret', 'nm-personalizedproduct' ),
						'desc' => __ ( 'Get client secret from your Instagram app.', 'nm-personalizedproduct' )
				),
				'redirect_uri' => array (
						'type' => 'text',
						'title' => __ ( 'Redirect URI', 'nm-personalizedproduct' ),
						'desc' => __ ( 'Paste redirect uri you used in Instagram app page, it MUST be matched.', 'nm-personalizedproduct' )
				),
